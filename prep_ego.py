"""
Downloads and reformats egohands dataset into a csv file
Taken from:
https://github.com/victordibia/handtracking/blob/master/egohands_dataset_clean.py
"""
        ...
        for pointlist in first:
            ...
            for point in pointlist:
                if len(point) == 2:
                    ...
                    cv2.putText(
                        img, ".", (x, y), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA
                    )
...
def generate_label_files(image_dir):
    ...
    for root, dirs, filenames in os.walk(image_dir):
        for dir in dirs:
            ...
            print(
                "Saved label csv for ", dir, image_dir + dir + "/" + dir + "_labels.csv"
            )
            ...
            for f in os.listdir(image_dir + dir):
                if f.split(".")[1] == "jpg":
                    ...
                    if loop_index in test_samp_array:
                        ...
                        os.rename(
                            image_dir + dir + "/" + f.split(".")[0] + ".csv",
                            "images/test/" + f.split(".")[0] + ".csv",
                        )
                    else:
                        os.rename(image_dir + dir + "/" + f, "images/train/" + f)
                        os.rename(
                            image_dir + dir + "/" + f.split(".")[0] + ".csv",
                            "images/train/" + f.split(".")[0] + ".csv",
                        )
